...
#+DESCRIPTION: This is my living Emacs config.
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :tangle ./init.el

* My Emacs Experience

I looked into Emacs already several years ago, but it was a similar journey to my VIM journey - at first glance it way too complex (and ugly as hell) and at that point in time I didn't want to invest the time. As with VIM, frequently revisiting Emacs, watching some YouTube videos about, etc., some basic concepts sank in and I WANTED to use it.
...
I like to see the current position both in statusbar and the line numbers in the gutter. In order to make the use of commands like =11 dd= easier for me, I use relative line numbers. For certain modes, the line numbers are turned off - I don't need line numbers in a terminal for example.
...
[[https://github.com/cofi/evil-leader][evil-leader]] is something I want to look into, but haven't found the time so far.

** evil-snipe

[[https://github.com/hlissner/evil-snipe][evil-snipe]] is something I want to look into but haven't found the time so far.
...
[[https://github.com/integral-dw/org-superstar-mode][org-superstar-mode]] replaces the asterixes in front of headlines with a unicode arrow as well as leading asterixes with a blank.
...
** Auto-tanlge init.org

To automatically tangle all the code blocks from this =init.org= into =init.el=, I added the following code block. Again, I got this from the [[https://www.youtube.com/watch?v=74zOY-vgkyw][Emacs from Scratch]] series.
